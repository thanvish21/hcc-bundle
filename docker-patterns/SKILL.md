...
description: "Multi-stage, BuildKit, layer caching, security — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, docker,patterns]
    related_skills: [hcc-bundle]
---

# docker-patterns

Multi-stage, BuildKit, layer caching, security
...
This skill provides Hermes-native patterns for **docker-patterns**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s docker-patterns "your task"` |
| With TDD | `hermes -s tdd,docker-patterns "build feature with tests"` |
| Security review | `hermes -s security-review,docker-patterns "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s docker-patterns "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s docker-patterns,agentic-engineering,git-workflow "Build feature end-to-end"
```
