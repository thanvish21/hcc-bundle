---
name: api-security
description: "Rate limiting, CORS, CSP, headers, validation — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, api,security]
    related_skills: [hcc-bundle]
---

# api-security

Rate limiting, CORS, CSP, headers, validation
...
This skill provides Hermes-native patterns for **api-security**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s api-security "your task"` |
| With TDD | `hermes -s tdd,api-security "build feature with tests"` |
| Security review | `hermes -s security-review,api-security "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s api-security "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s api-security,agentic-engineering,git-workflow "Build feature end-to-end"
```
