---
name: htmx-patterns
description: "HTMX hyperscript, progressive enhancement — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, htmx,patterns]
    related_skills: [hcc-bundle]
---

# htmx-patterns

HTMX hyperscript, progressive enhancement
...
This skill provides Hermes-native patterns for **htmx-patterns**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s htmx-patterns "your task"` |
| With TDD | `hermes -s tdd,htmx-patterns "build feature with tests"` |
| Security review | `hermes -s security-review,htmx-patterns "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s htmx-patterns "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s htmx-patterns,agentic-engineering,git-workflow "Build feature end-to-end"
```
