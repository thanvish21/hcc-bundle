...
description: "Next.js 14+ App Router, Server Components, Turbopack — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
This skill provides Hermes-native patterns for **nextjs-turbopack**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s nextjs-turbopack "your task"` |
| With TDD | `hermes -s tdd,nextjs-turbopack "build feature with tests"` |
| Security review | `hermes -s security-review,nextjs-turbopack "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s nextjs-turbopack "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s nextjs-turbopack,agentic-engineering,git-workflow "Build feature end-to-end"
```
