---
name: python-testing
description: "pytest, hypothesis, property-based, coverage — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
This skill provides Hermes-native patterns for **python-testing**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s python-testing "your task"` |
| With TDD | `hermes -s tdd,python-testing "build feature with tests"` |
| Security review | `hermes -s security-review,python-testing "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s python-testing "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s python-testing,agentic-engineering,git-workflow "Build feature end-to-end"
```
