...
description: "Django 5, ORM, DRF, async views, caching — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, django,patterns]
    related_skills: [hcc-bundle]
---

# django-patterns

Django 5, ORM, DRF, async views, caching
...
This skill provides Hermes-native patterns for **django-patterns**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s django-patterns "your task"` |
| With TDD | `hermes -s tdd,django-patterns "build feature with tests"` |
| Security review | `hermes -s security-review,django-patterns "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s django-patterns "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s django-patterns,agentic-engineering,git-workflow "Build feature end-to-end"
```
