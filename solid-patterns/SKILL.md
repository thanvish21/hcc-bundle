---
name: solid-patterns
description: "SolidJS signals, fine-grained reactivity — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
This skill provides Hermes-native patterns for **solid-patterns**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s solid-patterns "your task"` |
| With TDD | `hermes -s tdd,solid-patterns "build feature with tests"` |
| Security review | `hermes -s security-review,solid-patterns "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s solid-patterns "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s solid-patterns,agentic-engineering,git-workflow "Build feature end-to-end"
```
