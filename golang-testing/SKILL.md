---
name: golang-testing
description: "Go testing, testify, gomock, fuzzing — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, golang,testing]
    related_skills: [hcc-bundle]
---

# golang-testing

Go testing, testify, gomock, fuzzing
...
This skill provides Hermes-native patterns for **golang-testing**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s golang-testing "your task"` |
| With TDD | `hermes -s tdd,golang-testing "build feature with tests"` |
| Security review | `hermes -s security-review,golang-testing "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s golang-testing "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s golang-testing,agentic-engineering,git-workflow "Build feature end-to-end"
```
