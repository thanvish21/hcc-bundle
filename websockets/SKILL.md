---
name: websockets
description: "Socket.io, native WS, scaling, presence — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, websockets]
    related_skills: [hcc-bundle]
---

# websockets

Socket.io, native WS, scaling, presence
...
This skill provides Hermes-native patterns for **websockets**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s websockets "your task"` |
| With TDD | `hermes -s tdd,websockets "build feature with tests"` |
| Security review | `hermes -s security-review,websockets "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s websockets "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s websockets,agentic-engineering,git-workflow "Build feature end-to-end"
```
