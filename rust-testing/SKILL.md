---
name: rust-testing
description: "cargo test, proptest, mockall, integration tests — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, rust,testing]
    related_skills: [hcc-bundle]
---

# rust-testing

cargo test, proptest, mockall, integration tests
...
This skill provides Hermes-native patterns for **rust-testing**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s rust-testing "your task"` |
| With TDD | `hermes -s tdd,rust-testing "build feature with tests"` |
| Security review | `hermes -s security-review,rust-testing "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s rust-testing "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s rust-testing,agentic-engineering,git-workflow "Build feature end-to-end"
```
