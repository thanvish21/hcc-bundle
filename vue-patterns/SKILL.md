---
name: vue-patterns
description: "Vue 3 Composition API, Pinia, Nuxt 3 patterns — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
metadata:
  hermes:
    tags: [hermes, vue,patterns]
    related_skills: [hcc-bundle]
---

# vue-patterns

Vue 3 Composition API, Pinia, Nuxt 3 patterns
...
This skill provides Hermes-native patterns for **vue-patterns**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s vue-patterns "your task"` |
| With TDD | `hermes -s tdd,vue-patterns "build feature with tests"` |
| Security review | `hermes -s security-review,vue-patterns "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s vue-patterns "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s vue-patterns,agentic-engineering,git-workflow "Build feature end-to-end"
```
