---
name: observability
description: "OpenTelemetry, Prometheus, Grafana, Loki, Tempo — Hermes-native patterns adapted from ECC for Claude Code"
version: 1.0.0
author: Hermes Agent
license: MIT
...
This skill provides Hermes-native patterns for **observability**, adapted from the ECC (Everything Claude Code) ecosystem.

### Quick Reference

| Task | Command |
|------|---------|
| Get started | `hermes -s observability "your task"` |
| With TDD | `hermes -s tdd,observability "build feature with tests"` |
| Security review | `hermes -s security-review,observability "audit implementation"` |

### Common Patterns

```bash
# Example: Load skill and run task
hermes -s observability "Implement user authentication with JWT"

# Multi-skill: Combine with engineering practices
hermes -s observability,agentic-engineering,git-workflow "Build feature end-to-end"
```
